...
#define State_status_ENUMTYPE PlayStatus

#define Capability_typ_ENUMTYPE CapabilityType


#define Frame_typ_ENUMTYPE MessageType
...
#define SPIRC_PB_H_MAX_SIZE                      Capability_size
