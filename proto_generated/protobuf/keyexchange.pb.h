...
#define BuildInfo_product_ENUMTYPE Product
#define BuildInfo_platform_ENUMTYPE Platform2
...
#define ClientHello_cryptosuites_supported_ENUMTYPE Cryptosuite
...
#define KEYEXCHANGE_PB_H_MAX_SIZE                ClientHello_size
